package org.larse.events
{
	...
	public class PlotEvent extends Event
	{
		...
		public static const LOAD_VERTEX_HISTORY:String = "load_vertices_history"; //load previous interpreter's data
		public static const SHOW_HISTORY:String = "show_history"; //show previous interpreter's data
		...
		public function PlotEvent(type:String, data:Plot=null)
		{
