...
internal class _Super_VertexService extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{
    ...
    /**
      ...
      */
    public function createVertices(project_id:int, tsa:int, plotid:int, interpreter:int, sqlstr:String, history_flag:int) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("createVertices");
		var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(project_id,tsa,plotid,interpreter,sqlstr,history_flag) ;
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function getVerticesForPlot(project_id:int, tsa:int, plotid:int, interpreter:int, history_flag:int) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("getVerticesForPlot");
		var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(project_id,tsa,plotid,interpreter,history_flag) ;
        return _internal_token;
    }
