...
//  Vertex Service
//---------------------------------------------------------------------------
	public function saveVertex(project_id:int, tsa:int, plotid:int, interpreter:int, sql:String, history:int=0):AsyncToken {
		return vertexService.createVertices(project_id, tsa, plotid, interpreter, sql, history);
	}
	
	public function loadVerticesForPlot(project_id:int, tsa:int, plotid:int, interpreter:int, history:int=0):AsyncToken {
		return vertexService.getVerticesForPlot(project_id, tsa, plotid, interpreter, history);
	}
